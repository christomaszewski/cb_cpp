...
heuristic = rp.heuristics.EuclideanDistance()
layout = cb_cpp.layouts.StreamlinePattern(vehicle_radius, sensor_radius)
...
dv.save(f"{scenario_dir}/raw_constraints.png")
dv.clear_figure()
dv.plot_domain()
